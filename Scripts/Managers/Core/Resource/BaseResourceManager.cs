...
namespace SongLib
{
    public abstract class BaseResourceManager<U> : SingletonWithMono<U>, IResourceManager, IBaseManager where U : BaseResourceManager<U>, new()
    {
        ...
        // Scriptable Objects ============================
        protected GameResource<ScriptableObject> resourceSO;
        ...
        protected virtual void NewGameResource()
        {
            ...
            // Scriptable Objects ============================
            resourceSO = new GameResource<ScriptableObject>("Data");
        }
        ...
        public ScriptableObject GetSOData(string fileName) => resourceSO.GetResource(fileName);
